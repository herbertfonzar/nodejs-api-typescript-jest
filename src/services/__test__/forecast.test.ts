...
import stormGlassNormalizedResponseFixtures from '@test/fixtures/stormglass-normalized_weather_3.json'
...
describe('Forecast Service', () => {
    ...
    it('should return the forecast for a list of beaches', async () => {
        mockedStormGlassService.fetchPoints.mockResolvedValue(stormGlassNormalizedResponseFixtures)
