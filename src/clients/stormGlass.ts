...
export class ClientRequestError extends InternalError{
    constructor(message: string) {
        const internalMessage = 'Unexpected error when trying to communitcate to StormGlass'
...
export class StormGlass {
    readonly stormGlassAPIParams = 'smellDirection,swellHeight,swellPeriod,waveDirection,waveHeight,winDirection,windSpeed';
